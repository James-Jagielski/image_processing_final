...
C {devices/opin.sym} 510 0 0 0 {name=p2 lab=NQ}
C {devices/iopin.sym} 220 -190 3 0 {name=p3 lab=VP}
C {devices/iopin.sym} -60 170 2 0 {name=p4 lab=VN}
C {devices/iopin.sym} 500 220 0 0 {name=p5 lab=VN}
C {devices/ipin.sym} -60 -110 0 0 {name=p6 lab=D}
C {devices/ipin.sym} -60 0 0 0 {name=p7 lab=ND}
